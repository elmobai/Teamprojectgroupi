...
<div class="mdl-grid">
  ...
  <div class="mdl-cell mdl-cell--10-col mdl-shadow--2dp">
    <section class="login-register">
      ...
      <a href="https://itp-module-x14346081.c9users.io/index.php" class="mdl-button mdl-js-button mdl-button--raised mdl-button--colored">Cancel Booking</a>
      <a href="https://itp-module-x14346081.c9users.io/index.php" class="mdl-button mdl-js-button mdl-button--raised mdl-button--colored">Modify Booking</a></p>
